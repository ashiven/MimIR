...
int main(int argc, char** argv) {
    ...
    try {
        ...
        auto cli = lyra::cli()
            ...
            | lyra::opt(flags.slotted                        )["-s"]["--slotted"                ]("Use in conjunction with '--output-sexpr' to emit the program as symbolic expression in slotted-egraphs format. If your program uses the 'eqsat' plugin, equality saturation will be performed in 'slotted-egraphs' instead of 'egg'")
